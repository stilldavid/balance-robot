...
void loop()
{
  ...
  if (delt_t > 40) {
    ...
    // print some debug data every loop
    Serial.print("0,");
    Serial.print(dk1);
    Serial.print(",");
    Serial.print(dk2);
...
/**
 * Functions from Kris Winer, who rocks
